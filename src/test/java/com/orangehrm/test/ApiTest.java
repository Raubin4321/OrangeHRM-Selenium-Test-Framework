...
public class ApiTest {
	...
	public void verifyGetUserAPI() {
		...
		if (isStatusCodeValid) {
			...
			ExtentManager.logFailureAPI("Status Code Vaildation Failed ! ");
		}

		// Step 4: Validate user name
		ExtentManager.logStep("Validate username from response body ");
		...
		// Validate Email
		ExtentManager.logStep("Validate email from response body ");
